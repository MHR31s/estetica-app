    ...
    <main className="min-h-screen px-4 py-6 sm:px-6 lg:px-8">
      <section className="mx-auto flex min-h-[calc(100vh-48px)] max-w-6xl flex-col justify-center">
        <header className="mb-10 grid gap-6 lg:grid-cols-[1fr_auto] lg:items-center">
          ...
          <a href="/dashboard" className="inline-flex items-center justify-center gap-2 rounded-lg bg-ink px-6 py-4 text-sm font-semibold text-white shadow-soft transition hover:bg-jade">
        ...
        <footer className="mt-8 flex flex-col items-center justify-between gap-3 rounded-lg border border-black/5 bg-white/80 p-4 shadow-soft sm:flex-row">
          ...
          <a href="/dashboard" className="inline-flex items-center justify-center rounded-lg border border-black/10 px-5 py-3 text-sm font-semibold text-ink transition hover:border-jade hover:text-jade">
            Entrar
          </a>
        </footer>
      </section>
